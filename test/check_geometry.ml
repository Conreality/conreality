...
let v3_op_smul () = let v = V3.( * ) tvec3_1 2. in Alcotest.(check (list float)) "float list" [6.; 2.; 4.] [V3.x v; V3.y v; V3.z v]
...
let v3_crossproduct2 () =
  ...
  Alcotest.(check (list string)) "string list" (of_floats l) (of_floats [V3.x v; V3.y v; V3.z v])
  (*Alcotest.(check (list float)) "float list" l [V3.x v; V3.y v; V3.z v]*)
